...
public final class FindMeetingQueryTest {
  ...
  private FindMeetingQuery calendarQuery;

  @Before
  public void setUp() {
    calendarQuery = new FindMeetingQuery();
  }
  ...
  public void optionsForNoAttendees() {
    ...
    Collection<TimeRange> actual = calendarQuery.calendarQuery(NO_EVENTS, request);
  ...
  public void eventSplitsRestriction() {
    ...
    Collection<TimeRange> actual = calendarQuery.calendarQuery(events, request);
  ...
  @Test
  public void ignoreOptional() {
    // Includes an optional attendee with no time so they should be ignored.
    //           |--------------C--------------|
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  public void ignoreMiddle() {
    // Includes an optional attendee that gets rid of one timeRange that would exclude them.
    //                       |--C--|
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  @Test
  public void ignoreSmallOptional() {
    // Includes one one mandatory and optional attendee but the optional attendee
    // should be ignored.
    //                 |-B-|
    // Events  : |--A--|     |----A----|
    // Day     : |---------------------|
  ...
  public void twoOptionalAttendees() {
    // Two optional attendees with one viable meeting time.
    //
    // Events  : |--A-----| |---B--|
    // Day     : |---------------------|
    // Options :                   |---|
   ...
   public void twoBusyOptionalAttendees() {
    // Two optional attendees with no free time.
    //
    // Events  : |----A-----||----B----|
    // Day     : |---------------------|
    // Options :
  ...
  @Test
  public void optimizeForOptionals() {
    // Includes an optional attendee with no time so they should be ignored.
    //           |--------------C--------------|
    // Events  : |---A---|               |--B--|
    // Day     : |-----------------------------|
    ...
    Collection<TimeRange> actual = calendarQuery.calendarQuery(events, request);
    Collection<TimeRange> expected =
        Arrays.asList(TimeRange.fromStartEnd(TIME_0900AM, TIME_1100AM, true));
